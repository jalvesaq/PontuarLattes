...
\begin{longtable}{p{7cm}p{7cm}p{7cm}cc}
...
print(xtable(tab, align = aln, digits = 0, label = "tab:oriconc",
      ...
      booktabs = TRUE, hline.after = c(-1, 0, nrow(tab) - 2, nrow(tab)),
      include.rownames = FALSE)
@
...
print(xtable(tab, align = aln, digits = 0, label = "tab:oriand",
      ...
      hline.after = c(-1, 0, nrow(tab) - 2, nrow(tab)), include.rownames = FALSE)
@
...
valores, a soma ponderada das média é de
