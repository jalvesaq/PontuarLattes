...
\caption{Links para ORCID e Lattes e data de atualização do Currículo Lattes} \\
  \toprule
...
out <- capture.output(print(xtable(dias, align = "lcclr", caption = "Links para ORCID e Lattes e data de atualização do Currículo Lattes"),
